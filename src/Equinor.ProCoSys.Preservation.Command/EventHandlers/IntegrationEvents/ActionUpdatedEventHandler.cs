...
public class ActionUpdatedEventHandler : INotificationHandler<ActionUpdatedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public ActionUpdatedEventHandler(IIntegrationEventPublisher integrationEventPublisher,

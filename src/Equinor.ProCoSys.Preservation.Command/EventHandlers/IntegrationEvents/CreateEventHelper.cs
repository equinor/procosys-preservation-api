...
public class CreateEventHelper : ICreateEventHelper
{
    ...
    public CreateEventHelper(IModeRepository modeRepository, IJourneyRepository journeyRepository, IPersonRepository personRepository, IPreservationPeriodTagRequirement preservationPeriodTagRequirement, IProjectRepository projectRepository, IResponsibleRepository responsibleRepository, IRequirementTypeRepository requirementTypeRepository, ITagProjectId tagProjectId)
    {
    ...
    public async Task<IPreservationPeriodEventV1> CreatePreservationPeriodEvent(PreservationPeriod preservationPeriod)
    {
        ...
        var tagRequirement = await _preservationPeriodTagRequirement.Retrieve(preservationPeriod);

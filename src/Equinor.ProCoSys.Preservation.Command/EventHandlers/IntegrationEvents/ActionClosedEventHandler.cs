...
public class ActionClosedEventHandler : INotificationHandler<ActionClosedEvent>
{
    ...
    public ActionClosedEventHandler(IIntegrationEventPublisher integrationEventPublisher,
    ...
    {
        var actionEvent = await _createEventHelper.CreateActionEvent(notification.Action, notification.SourceGuid);

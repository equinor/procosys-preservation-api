...
public class UpdateActionEventHandler : INotificationHandler<ActionUpdatedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public UpdateActionEventHandler(IIntegrationEventPublisher integrationEventPublisher,

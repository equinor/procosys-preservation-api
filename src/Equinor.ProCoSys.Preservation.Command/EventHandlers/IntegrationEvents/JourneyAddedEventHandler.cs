...
public class JourneyAddedEventHandler : INotificationHandler<JourneyAddedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public JourneyAddedEventHandler(IIntegrationEventPublisher integrationEventPublisher,

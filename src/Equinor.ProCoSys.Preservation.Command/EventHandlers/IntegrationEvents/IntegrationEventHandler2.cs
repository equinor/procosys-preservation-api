...
public class IntegrationEventHandler2<TNotificationEvent, TEntity>
    ...
    where TEntity : PlantEntityBase, ICreationAuditable, IModificationAuditable, IHaveGuid
{
    ...
    public IntegrationEventHandler2(IPublishEntityEventHelper<TEntity> eventPublisher) => _eventPublisher = eventPublisher;

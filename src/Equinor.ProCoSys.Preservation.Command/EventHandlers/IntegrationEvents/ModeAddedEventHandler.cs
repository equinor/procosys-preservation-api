...
public class ModeAddedEventHandler : INotificationHandler<ModeAddedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public ModeAddedEventHandler(IIntegrationEventPublisher integrationEventPublisher,

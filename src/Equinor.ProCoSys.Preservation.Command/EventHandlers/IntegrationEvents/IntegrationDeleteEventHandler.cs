...
{
    private readonly IPublishDeleteEntityEventHelper<TEntity> _eventPublisher;

    public IntegrationDeleteEventHandler(IPublishDeleteEntityEventHelper<TEntity> eventPublisher) => _eventPublisher = eventPublisher;

...
public class PreservationPeriodUpdatedEventHandler : INotificationHandler<PreservationPeriodUpdatedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public PreservationPeriodUpdatedEventHandler(IIntegrationEventPublisher integrationEventPublisher, ICreateEventHelper createEventHelper)
    {

...
public class ModeUpdatedEventHandler : INotificationHandler<ModeUpdatedEvent>
{
    private readonly IIntegrationEventPublisher _integrationEventPublisher;
    private readonly ICreateEventHelper _createEventHelper;

    public ModeUpdatedEventHandler(IIntegrationEventPublisher integrationEventPublisher,

...
{
    public class SetInServiceCommandValidator : AbstractValidator<SetInServiceCommand>
    {
        public SetInServiceCommandValidator(
            ...
            IRowVersionValidator rowVersionValidator)
        {
            ...
            async Task<bool> IsReadyToBeSetInServiceAsync(int tagId, CancellationToken token)
                => await tagValidator.IsReadyToBeSetInServiceAsync(tagId, token);

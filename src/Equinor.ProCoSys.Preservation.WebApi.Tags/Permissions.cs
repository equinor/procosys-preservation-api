namespace Equinor.ProCoSys.Preservation.WebApi.Tags
{
    public class Permissions
    {
        ...
        public const string PRESERVATION_PLAN_ATTACHFILE = "PRESERVATION_PLAN/ATTACHFILE";
        public const string PRESERVATION_PLAN_DETACHFILE = "PRESERVATION_PLAN/DETACHFILE";
        public const string PRESERVATION_PLAN_READ = "PRESERVATION_PLAN/READ";

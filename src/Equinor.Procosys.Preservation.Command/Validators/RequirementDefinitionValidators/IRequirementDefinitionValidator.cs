...
namespace Equinor.Procosys.Preservation.Command.Validators.RequirementDefinitionValidators
{
    public interface IRequirementDefinitionValidator
    {
        ...
        Task<bool> BeUniqueRequirements(IEnumerable<int> updatedRequirements, IList<RequirementForCommand> newRequirements, CancellationToken token);
        Task<bool> RequirementUsageIsForAllJourneysAsync(IEnumerable<int> updatedRequirements, IList<RequirementForCommand> newRequirements, CancellationToken token);
        Task<bool> RequirementUsageIsForJourneysWithoutSupplierAsync(IEnumerable<int> updatedRequirements, IList<RequirementForCommand> newRequirements, CancellationToken token);
        Task<bool> RequirementUsageIsNotForSupplierStepOnlyAsync(IEnumerable<int> updatedRequirements, IList<RequirementForCommand> newRequirements, CancellationToken token);

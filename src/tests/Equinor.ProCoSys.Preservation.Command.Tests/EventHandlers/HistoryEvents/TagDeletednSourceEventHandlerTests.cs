...
{
    [TestClass]
    public class TagDeletedInSourceEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private TagDeletedInSourceEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new TagDeletedInSourceEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddTagDeletedInSourceHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new TagDeletedInSourceEvent(plant, sourceGuid), default);
            ...
            Assert.AreEqual(EventType.TagDeletedInSource, _historyAdded.EventType);

...
{
    [TestClass]
    public class TagUnvoidedInSourceEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private TagUnvoidedInSourceEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new TagUnvoidedInSourceEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddTagUnvoidedInSourceHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new TagUnvoidedInSourceEvent(plant, sourceGuid), default);
            ...
            Assert.AreEqual(EventType.TagUnvoidedInSource, _historyAdded.EventType);

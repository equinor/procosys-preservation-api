...
namespace Equinor.ProCoSys.Preservation.Command.Tests.MiscCommands.Clone
{
    ...
    public class CloneCommandValidatorTests
    {
        ...
        public void Setup_OkState()
        {
            ...
            _permissionCacheMock.Setup(r => r.HasCurrentUserAccessToPlantAsync(_sourcePlant, It.IsAny<CancellationToken>())).Returns(Task.FromResult(true));
            _permissionCacheMock.Setup(r => r.HasCurrentUserAccessToPlantAsync(_targetPlant, It.IsAny<CancellationToken>())).Returns(Task.FromResult(true));
        ...
        {
            _permissionCacheMock.Setup(r => r.HasCurrentUserAccessToPlantAsync(_targetPlant, It.IsAny<CancellationToken>())).Returns(Task.FromResult(false));
        ...
        {
            _permissionCacheMock.Setup(r => r.HasCurrentUserAccessToPlantAsync(_sourcePlant, It.IsAny<CancellationToken>())).Returns(Task.FromResult(false));
        ...
        public async Task Validate_ShouldFail_WhenTargetPlantIsABasisPlant()
        {
            ...
            _permissionCacheMock.Setup(r => r.HasCurrentUserAccessToPlantAsync(targetPlant, It.IsAny<CancellationToken>())).Returns(Task.FromResult(true));

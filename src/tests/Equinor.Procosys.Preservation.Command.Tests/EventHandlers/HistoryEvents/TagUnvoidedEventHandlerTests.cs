...
{
    [TestClass]
    public class TagUnvoidedEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private TagUnvoidedEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new TagUnvoidedEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddTagUnvoidedHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new TagUnvoidedEvent(plant, objectGuid), default);
            ...
            Assert.AreEqual(EventType.TagUnvoided, _historyAdded.EventType);

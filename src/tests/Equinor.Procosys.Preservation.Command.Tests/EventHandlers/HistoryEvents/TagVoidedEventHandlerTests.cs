...
{
    [TestClass]
    public class TagVoidedEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private TagVoidedEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new TagVoidedEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddTagVoidedHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new TagVoidedEvent(plant, objectGuid), default);
            ...
            Assert.AreEqual(EventType.TagVoided, _historyAdded.EventType);

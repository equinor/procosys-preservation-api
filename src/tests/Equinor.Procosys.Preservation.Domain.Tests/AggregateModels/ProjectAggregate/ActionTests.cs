...
namespace Equinor.Procosys.Preservation.Domain.Tests.AggregateModels.ProjectAggregate
{
    ...
    public class ActionTests
    {
        ...
        public void Setup()
        {
            ...
            _dut = new Action("SchemaA", "DescA", _utcNow, _personMock.Object, _utcNow);
        }

        [TestMethod]
        public void Constructor_ShouldSetProperties_WithoutDue()
        {
            _dut = new Action("SchemaA", "DescA", _utcNow, _personMock.Object, null);
        ...
        public void Constructor_ShouldThrowException_WhenCreatedIsNotUtc()
            => Assert.ThrowsException<ArgumentException>(() =>
                new Action("SchemaA", "DescA", DateTime.Now, _personMock.Object, _utcNow)
            );

        [TestMethod]
        public void Constructor_ShouldThrowException_WhenCreatedByIsNull()
            => Assert.ThrowsException<ArgumentNullException>(() =>
                new Action("SchemaA", "DescA", _utcNow, null, _utcNow)
            );

        [TestMethod]
        public void Constructor_ShouldThrowException_WhenDueIsNotUtc()
            => Assert.ThrowsException<ArgumentException>(() =>
                new Action("SchemaA", "DescA", _utcNow, _personMock.Object, DateTime.Now)
            );

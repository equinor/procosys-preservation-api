...
namespace Equinor.Procosys.Preservation.Domain.Tests.AggregateModels.ProjectAggregate
{
    ...
    public class PreservationPeriodTests
    {
        ...
        {
            var dut = new PreservationPeriod(TestPlant, TimeService.UtcNow, PreservationPeriodStatus.NeedsUserInput);
        ...
        public void Constructor_ShouldThrowException_WhenStatusIsPreserved()
            => Assert.ThrowsException<ArgumentException>(() =>
                new PreservationPeriod(TestPlant, TimeService.UtcNow, PreservationPeriodStatus.Preserved)
            );

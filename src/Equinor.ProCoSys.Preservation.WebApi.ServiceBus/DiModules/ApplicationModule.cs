...
using Equinor.ProCoSys.Preservation.WebApi.ServiceBus.Authorizations;
using Equinor.ProCoSys.Preservation.WebApi.ServiceBus.Excel;
using Equinor.ProCoSys.Preservation.WebApi.ServiceBus.Misc;
using Equinor.ProCoSys.Preservation.WebApi.ServiceBus.Synchronization;
using MediatR;
...
namespace Equinor.ProCoSys.Preservation.WebApi.ServiceBus.DiModules
{
    public static class ApplicationModule
    {
        public static void AddApplicationModules(this IServiceCollection services, IConfiguration configuration, TokenCredential credential)
        {
            ...
            services.AddScoped<IProjectApiForApplicationService, ProjectApiForApplicationService>();
            services.AddScoped<IProjectApiForUserService, ProjectApiForUserService>();

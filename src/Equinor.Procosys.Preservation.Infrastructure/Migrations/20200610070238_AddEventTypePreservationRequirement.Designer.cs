...
namespace Equinor.Procosys.Preservation.Infrastructure.Migrations
{
    ...
    [Migration("20200610070238_AddEventTypePreservationRequirement")]
    partial class AddEventTypePreservationRequirement
    {
            ...
            modelBuilder.Entity("Equinor.Procosys.Preservation.Domain.AggregateModels.HistoryAggregate.History", b =>
                {
                    ...
                    b.HasCheckConstraint("constraint_history_check_valid_event_type", "EventType in ('AddRequirement','DeleteRequirement','VoidRequirement','UnvoidRequirement','PreserveRequirement','VoidTag','UnvoidTag','StartPreservation','CompletePreservation','ChangeInterval','ManualTransfer','AutomaticTransfer')");
                });
